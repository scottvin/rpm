...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMASPECT_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMASPECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMASPECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMASPECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMASPECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMASPECT actions', async () => {
      const expectedActions = [
        {
