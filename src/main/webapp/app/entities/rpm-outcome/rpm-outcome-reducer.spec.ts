...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMOUTCOME_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMOUTCOME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMOUTCOME actions', async () => {
      const expectedActions = [
        {
