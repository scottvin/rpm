...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rpm-plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMPLAN actions', async () => {
      const expectedActions = [
        {
