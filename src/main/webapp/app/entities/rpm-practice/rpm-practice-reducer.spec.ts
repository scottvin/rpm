...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMPRACTICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMPRACTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMPRACTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMPRACTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMPRACTICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMPRACTICE actions', async () => {
      const expectedActions = [
        {
