...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMVISION_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMVISION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMVISION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMVISION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMVISION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMVISION actions', async () => {
      const expectedActions = [
        {
