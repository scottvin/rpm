...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMACTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMACTION actions', async () => {
      const expectedActions = [
        {
