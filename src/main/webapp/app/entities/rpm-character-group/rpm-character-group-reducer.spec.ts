...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './rpm-character-group.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMCHARACTERGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMCHARACTERGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMCHARACTERGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMCHARACTERGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMCHARACTERGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMCHARACTERGROUP actions', async () => {
      const expectedActions = [
        {
