...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rpm-quote.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMQUOTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMQUOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMQUOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMQUOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMQUOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMQUOTE actions', async () => {
      const expectedActions = [
        {
