...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rpm-role.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMROLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMROLE actions', async () => {
      const expectedActions = [
        {
