...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMPROJECT_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMPROJECT actions', async () => {
      const expectedActions = [
        {
