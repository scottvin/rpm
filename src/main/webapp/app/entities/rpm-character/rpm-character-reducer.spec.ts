...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMCHARACTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMCHARACTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMCHARACTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMCHARACTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMCHARACTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMCHARACTER actions', async () => {
      const expectedActions = [
        {
