...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMRESOURCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMRESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMRESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMRESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMRESOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMRESOURCE actions', async () => {
      const expectedActions = [
        {
