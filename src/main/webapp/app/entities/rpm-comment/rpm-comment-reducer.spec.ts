...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMCOMMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMCOMMENT actions', async () => {
      const expectedActions = [
        {
