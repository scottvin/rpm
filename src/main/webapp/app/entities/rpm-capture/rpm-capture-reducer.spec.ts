...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMCAPTURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMCAPTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMCAPTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMCAPTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMCAPTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMCAPTURE actions', async () => {
      const expectedActions = [
        {
