...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMCATEGORY actions', async () => {
      const expectedActions = [
        {
