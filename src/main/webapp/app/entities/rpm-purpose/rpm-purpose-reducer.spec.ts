...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMPURPOSE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMPURPOSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMPURPOSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMPURPOSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMPURPOSE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMPURPOSE actions', async () => {
      const expectedActions = [
        {
