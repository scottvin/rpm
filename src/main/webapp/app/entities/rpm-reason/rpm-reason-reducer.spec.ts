...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMREASON_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMREASON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMREASON actions', async () => {
      const expectedActions = [
        {
