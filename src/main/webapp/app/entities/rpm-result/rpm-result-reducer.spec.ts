...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RPMRESULT_LIST actions', async () => {
    ...
    it('dispatches FETCH_RPMRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RPMRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RPMRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RPMRESULT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RPMRESULT actions', async () => {
      const expectedActions = [
        {
